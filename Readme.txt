...
2) letters_Model_training :- In this i have used a alphabet datset from kaggle and created a model for alphabets prediction and saved that as "only_letters_model.h5" .
